                        ...
                        <table class="tablesaw m-t-20 table m-b-0" data-tablesaw-mode="stack">
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  {!! link_to_route('citas.edit', $title = 'Posponer Cita', $parameters = $pcitas->id, $attributes = ['class' => 'btn btn-outline-primary waves-effect waves-light btn-sm']); !!}
                                  {!! Form::open( ['route' => ['citas.destroy', $pcitas->id],'method'=>'DELETE'] ) !!}
